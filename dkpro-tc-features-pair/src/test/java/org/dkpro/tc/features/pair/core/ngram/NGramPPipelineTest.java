...
public class NGramPPipelineTest extends PPipelineTestBase {
	/**
	...
	public void testView1Features() throws Exception {
		...
		test.parameters = new Object[] { LuceneNGramPFE.PARAM_UNIQUE_EXTRACTOR_NAME, "123",
				LuceneNGramPFE.PARAM_NGRAM_MIN_N_VIEW1, 1, LuceneNGramPFE.PARAM_NGRAM_MAX_N_VIEW1, 1,
				LuceneNGramPFE.PARAM_USE_VIEW1_NGRAMS_AS_FEATURES, true,
				LuceneNGramPFE.PARAM_USE_VIEW2_NGRAMS_AS_FEATURES, false,
				LuceneNGramPFE.PARAM_USE_VIEWBLIND_NGRAMS_AS_FEATURES, false, LuceneNGramPFE.PARAM_SOURCE_LOCATION,
				test.lucenePath, LuceneNGramPMetaCollector.PARAM_TARGET_LOCATION, test.lucenePath };
		test.runPipeline();
	...
	public void testView2Features() throws Exception {
		...
		test.initialize();
		test.parameters = new Object[] { LuceneNGramPFE.PARAM_UNIQUE_EXTRACTOR_NAME, "123",
				LuceneNGramPFE.PARAM_NGRAM_MIN_N_VIEW2, 1, LuceneNGramPFE.PARAM_NGRAM_MAX_N_VIEW2, 1,
	...
	public void testViewBlindFeatures() throws Exception {
		...
		test.parameters = new Object[] { LuceneNGramPFE.PARAM_UNIQUE_EXTRACTOR_NAME, "123",
				...
				LuceneNGramPFE.PARAM_USE_VIEW1_NGRAMS_AS_FEATURES, false,
				LuceneNGramPFE.PARAM_USE_VIEW2_NGRAMS_AS_FEATURES, false,
				LuceneNGramPFE.PARAM_USE_VIEWBLIND_NGRAMS_AS_FEATURES, true, LuceneNGramPFE.PARAM_SOURCE_LOCATION,
				test.lucenePath, LuceneNGramPMetaCollector.PARAM_TARGET_LOCATION, test.lucenePath };
		test.runPipeline();
	...
	public void testViewBlindFeaturesMarkedWithLocalView() throws Exception {
		...
		test.parameters = new Object[] { LuceneNGramPFE.PARAM_UNIQUE_EXTRACTOR_NAME, "123",
				...
				LuceneNGramPFE.PARAM_MARK_VIEWBLIND_NGRAMS_WITH_LOCAL_VIEW, true, LuceneNGramPFE.PARAM_SOURCE_LOCATION,
				test.lucenePath, LuceneNGramPMetaCollector.PARAM_TARGET_LOCATION, test.lucenePath };
		test.runPipeline();
	...
	public void testNonDefaultSizes() throws Exception {
		...
		test.initialize();
		test.parameters = new Object[] { LuceneNGramPFE.PARAM_UNIQUE_EXTRACTOR_NAME, "123",
				LuceneNGramPFE.PARAM_NGRAM_MIN_N_VIEW1, 4, LuceneNGramPFE.PARAM_NGRAM_MAX_N_VIEW1, 4,
				LuceneNGramPFE.PARAM_NGRAM_MIN_N_VIEW2, 4, LuceneNGramPFE.PARAM_NGRAM_MAX_N_VIEW2, 4,
	...
	public void testAlphabeticalCase() throws Exception {
		...
		test.initialize();
		test.parameters = new Object[] { LuceneNGramPFE.PARAM_UNIQUE_EXTRACTOR_NAME, "123",
				LuceneNGramPFE.PARAM_NGRAM_LOWER_CASE, false, LuceneNGramPFE.PARAM_NGRAM_MIN_N_VIEW1, 1,
				LuceneNGramPFE.PARAM_NGRAM_MAX_N_VIEW1, 1, LuceneNGramPFE.PARAM_USE_VIEW1_NGRAMS_AS_FEATURES, true,
				LuceneNGramPFE.PARAM_USE_VIEW2_NGRAMS_AS_FEATURES, false,
				LuceneNGramPFE.PARAM_USE_VIEWBLIND_NGRAMS_AS_FEATURES, false, LuceneNGramPFE.PARAM_SOURCE_LOCATION,
				test.lucenePath, LuceneNGramPMetaCollector.PARAM_TARGET_LOCATION, test.lucenePath };
		test.runPipeline();
		...
		test.initialize();
		test.parameters = new Object[] { LuceneNGramPFE.PARAM_UNIQUE_EXTRACTOR_NAME, "123",
				LuceneNGramPFE.PARAM_NGRAM_LOWER_CASE, true, LuceneNGramPFE.PARAM_NGRAM_MIN_N_VIEW1, 1,
				LuceneNGramPFE.PARAM_NGRAM_MAX_N_VIEW1, 1, LuceneNGramPFE.PARAM_USE_VIEW1_NGRAMS_AS_FEATURES, true,
				LuceneNGramPFE.PARAM_USE_VIEW2_NGRAMS_AS_FEATURES, false,
				LuceneNGramPFE.PARAM_USE_VIEWBLIND_NGRAMS_AS_FEATURES, false, LuceneNGramPFE.PARAM_SOURCE_LOCATION,
				test.lucenePath, LuceneNGramPMetaCollector.PARAM_TARGET_LOCATION, test.lucenePath };
	...
	/**
	 * Tests the stopword list to make sure stopwords are not in ngrams. First
	 * part of test shows ngrams with stopwords are present, and second part of
	 * test shows they have been removed.
	 * 
	 * @throws Exception
	 */
	@Test
	public void testStopwordRemoval() throws Exception {
		...
		test.parameters = new Object[] { LuceneNGramPFE.PARAM_UNIQUE_EXTRACTOR_NAME, "123",
				...
				LuceneNGramPFE.PARAM_USE_VIEW1_NGRAMS_AS_FEATURES, false,
				LuceneNGramPFE.PARAM_USE_VIEW2_NGRAMS_AS_FEATURES, false,
				LuceneNGramPFE.PARAM_USE_VIEWBLIND_NGRAMS_AS_FEATURES, true, LuceneNGramPFE.PARAM_NGRAM_STOPWORDS_FILE,
				"src/test/resources/data/stopwords.txt", LuceneNGramPFE.PARAM_SOURCE_LOCATION, test.lucenePath,
	...
	protected void getFeatureExtractorCollector(List<Object> parameterList) throws ResourceInitializationException {
		...
		featExtractorConnector = TaskUtils.getFeatureExtractorConnector(outputPath.getAbsolutePath(),
				JsonDataWriter.class.getName(), Constants.LM_SINGLE_LABEL, Constants.FM_PAIR, false, false, false,
				false, Collections.emptyList(), fes, new String[]{});
	}
