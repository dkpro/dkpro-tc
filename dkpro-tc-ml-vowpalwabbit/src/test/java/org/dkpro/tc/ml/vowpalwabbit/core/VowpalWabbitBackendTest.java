...
public class VowpalWabbitBackendTest
{
    File data;
    File model;
    ...
    public void setup() throws IOException
    {
        ...
        model = FileUtil.createTempFile("vowaplWabbit", ".model");
    }
    ...
    {
        TcPredictor predictor = new VowpalWabbitPredictor();
    ...
    {
        TcTrainer trainer = new VowpalWabbitTrainer();
        long sizeBefore = model.length();
        trainer.train(data, model, Arrays.asList(new String []{"--oaa", "2"}));
