...
import de.tudarmstadt.ukp.dkpro.tc.examples.io.NERUnitDemoReader;
    ...
    implements Constants
{
    ...
    public static ParameterSpace getParameterSpace()
    {
        ...
        dimReaders.put(DIM_READER_TRAIN, NERUnitDemoReader.class);
        dimReaders.put(
                DIM_READER_TRAIN_PARAMS,
                Arrays.asList(new Object[] { NERUnitDemoReader.PARAM_LANGUAGE, "de",
                		NERUnitDemoReader.PARAM_SOURCE_LOCATION, corpusFilePathTrain,
                		NERUnitDemoReader.PARAM_PATTERNS,
                		INCLUDE_PREFIX + "*.txt" }));
