...
import org.cleartk.classifier.weka.multilabel.DefaultSerializedMekaDataWriter;
import org.uimafit.descriptor.ConfigurationParameter;

public class DKProTCMultiLabelDataWriterFactory
    ...
    implements DataWriterFactory<String[]>
{
    ...
    {
        if (!featuresInMemory) {
            DefaultSerializedMekaDataWriter datawriter = new DefaultSerializedMekaDataWriter(
                    outputDirectory);
            ...
            DefaultMekaDataWriter datawriter = new DefaultMekaDataWriter(outputDirectory);
            datawriter.setUseDenseInstances(addInstanceId);
            return datawriter;
        }
    }
