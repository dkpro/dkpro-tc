...
public abstract class AbstractWekaClassifierBuilder <OUTCOME>
		extends
		ClassifierBuilder_ImplBase<AbstractWekaClassifier<OUTCOME>, Iterable<Feature>, OUTCOME, String> {

	public AbstractWekaClassifierBuilder() {
		super();
	...
	public void trainClassifier(File dir, String... args) throws Exception {
		...
		try{
		fileReader = new InputStreamReader(new BufferedInputStream(new GZIPInputStream(new FileInputStream(trainingData),65536),1048576));
		Instances inst = new Instances(fileReader);
		inst.setClass(inst.attribute("outcome"));
	...
	@Override
	abstract protected AbstractWekaClassifier<OUTCOME> newClassifier();

	@Override
	protected void packageClassifier(File dir, JarOutputStream modelStream)
			throws IOException {
		super.packageClassifier(dir, modelStream);
		JarStreams.putNextJarEntry(modelStream, "model.weka", new File(dir,
				"model.weka"));
	}
	...
	protected void unpackageClassifier(JarInputStream modelStream)
		...
		JarStreams.getNextJarEntry(modelStream, "model.weka");
