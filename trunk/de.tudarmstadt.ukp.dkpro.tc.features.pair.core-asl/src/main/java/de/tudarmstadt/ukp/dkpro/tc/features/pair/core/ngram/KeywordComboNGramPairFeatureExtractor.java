        ...
        throws ResourceInitializationException
    {
        ...
        try {
            ...
            for (ScoreDoc hit : hits) {
                ...
                FrequencyDistribution<String> ngramArray1 = toFD(d.getValues(KEYWORD_NGRAM_FIELD1));
                FrequencyDistribution<String> ngramArray2 = toFD(d.getValues(KEYWORD_NGRAM_FIELD2));
