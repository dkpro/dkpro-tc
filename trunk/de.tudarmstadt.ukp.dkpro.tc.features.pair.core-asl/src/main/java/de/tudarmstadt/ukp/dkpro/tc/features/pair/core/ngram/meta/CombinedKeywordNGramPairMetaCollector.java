...
//    		System.out.println("KeywordComboMeta70 Got pair: " + ngram1 + ComboUtils.JOINT + ngram2);
            ...
            if (combinedSize <= ngramMaxNCombo
            	...
            	addField(jcas, KeywordComboNGramPairFeatureExtractor.LUCENE_NGRAM_FIELD_KEYWORDCOMBO, ngram1 + ComboUtils.JOINT + ngram2);
            }
    	}
    }
