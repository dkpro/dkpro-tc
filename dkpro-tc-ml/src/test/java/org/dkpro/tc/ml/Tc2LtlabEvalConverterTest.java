...
public class Tc2LtlabEvalConverterTest
{
    ...
    public void testDocumentModeDataFormat() throws Exception
    {
        ...
        EvaluationData<String> data = Tc2LtlabEvalConverter.convertSingleLabelModeId2Outcome(
                new File("src/test/resources/id2outcome/convert/singleLabelID2outcome.txt"));
    ...
    public void testSingleLabelSequenceModeDataFormat() throws Exception
    {
        ...
        EvaluationData<String> data = Tc2LtlabEvalConverter
                .convertSingleLabelModeId2Outcome(new File(
                        "src/test/resources/id2outcome/convert/sequenceSingleLabelId2outcome.txt"));
    ...
    public void testRegressionModeDataFormat() throws Exception
    {
        EvaluationData<Double> data = Tc2LtlabEvalConverter.convertRegressionModeId2Outcome(
                new File("src/test/resources/id2outcome/convert/regressionID2outcome.txt"));
    ...
    {
        EvaluationData<String> data = Tc2LtlabEvalConverter.convertMultiLabelModeId2Outcome(
                new File("src/test/resources/id2outcome/convert/multiLabelId2outcome.txt"));
    ...
    public void testMultilabelModeDataFormatInteger() throws Exception
    {
        EvaluationData<Integer> data = Tc2LtlabEvalConverter
                .convertMultiLabelModeId2OutcomeUseInteger(
                        new File("src/test/resources/id2outcome/convert/multiLabelId2outcome.txt"));
        ...
        assertTrue(compareIntArrays(prediction, new Integer[] { 1, 0, 0, 0, 0 }));
