        ...
        throws AnalysisEngineProcessException
    {
        ...
        if (learningMode.equals(Constants.LM_SINGLE_LABEL)) {
            ...
            throw new AnalysisEngineProcessException(
                    new TextClassificationException("Please set a valid learning mode"));
        }

        return learningModeI;
    }

    public static int featureModeLabel2int(String featureMode) throws AnalysisEngineProcessException
    {
        int featureModeI = 0;
        ...
        if (featureMode.equals(Constants.FM_DOCUMENT)) {
            ...
            throw new AnalysisEngineProcessException(
                    new TextClassificationException("Please set a valid feature mode"));
        }
