...
public class DictionaryMappingAnnotator extends LookupResourceAnnotator {
	...
	public void collectionProcessComplete() {
		init();// initialize at the end, the resources we need are not available
				// during initialization of the annotator!
