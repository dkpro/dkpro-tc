 ...
 *
 */
public class XgboostSaveAndLoadModelDocumentRegression extends TestCaseSuperClass implements Constants {
	...
	private ParameterSpace regressionGetParameterSpace() throws Exception {
		...
		Dimension<List<Object>> dimClassificationArgs = Dimension.create(DIM_CLASSIFICATION_ARGS,
				Arrays.asList(new Object[] {new XgboostAdapter(), "booster=gblinear", "reg:logistic" }));

		Dimension<TcFeatureSet> dimFeatureSets = Dimension.create(DIM_FEATURE_SET,
				new TcFeatureSet(
						TcFeatureFactory.create(AvgSentenceRatioPerDocument.class), TcFeatureFactory.create(WordNGram.class),
