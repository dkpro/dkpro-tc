...
public class XgboostSaveAndLoadModelDocumentSingleLabelTest extends TestCaseSuperClass implements Constants {
	...
	public void setup() throws Exception {
		super.setup();
		DemoUtils.setDkproHome(XgboostSaveAndLoadModelDocumentSingleLabelTest.class.getSimpleName());
	}
