 ...
 * exception.
 */
public class LibsvmDocumentPlainTest extends TestCaseSuperClass {
	LibsvmDocumentPlain javaExperiment;
	...
	public void setup() throws Exception {
		...
		javaExperiment = new LibsvmDocumentPlain();
		pSpace = LibsvmDocumentPlain.getParameterSpace();
	}

	@Test
	public void testJavaTrainTest() throws Exception {
		javaExperiment.runTrainTest(pSpace);
		assertEquals(0.75, getAccuracy(ContextMemoryReport.id2outcomeFiles, "Libsvm"), 0.1);
