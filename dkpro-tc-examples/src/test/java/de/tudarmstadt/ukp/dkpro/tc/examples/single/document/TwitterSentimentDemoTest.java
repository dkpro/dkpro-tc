 ...
 * 
 */
public class TwitterSentimentDemoTest extends JavaDemosTest_Base
{
    TwitterSentimentDemo javaExperiment;
        ...
        throws Exception
    {
        ...
        javaExperiment = new TwitterSentimentDemo();
        pSpace = TwitterSentimentDemo.getParameterSpace();
    }
