...
public class SVMHMMSaveAndLoadModelTest implements Constants {
	...
	private void executeSaveModelIntoTemporyFolder(ParameterSpace aPSpace, File aModelFolder) throws Exception {
		SaveModelSvmhmmBatchTask batch = new SaveModelSvmhmmBatchTask("TestSaveModel", aModelFolder,
				SVMHMMAdapter.class, createEngineDescription(NoOpAnnotator.class));
	...
	private ParameterSpace getParameterSpace() {
		...
		dimReaders.put(DIM_READER_TRAIN_PARAMS, Arrays.asList(BrownCorpusReader.PARAM_SOURCE_LOCATION, trainFolder,
		...
		Dimension<List<Object>> dimPipelineParameters = Dimension.create(DIM_PIPELINE_PARAMS,
				Arrays.asList(new Object[] { NGramFeatureExtractorBase.PARAM_NGRAM_USE_TOP_K, 500,
						NGramFeatureExtractorBase.PARAM_NGRAM_MIN_N, 1, NGramFeatureExtractorBase.PARAM_NGRAM_MAX_N,
						3 }));
	...
	public void loadModel() throws Exception {
		...
		SimplePipeline.runPipeline(
				CollectionReaderFactory.createReader(StringReader.class, StringReader.PARAM_DOCUMENT_TEXT,
						"This is an example text. It has 2 sentences.", StringReader.PARAM_LANGUAGE, "en"),
				AnalysisEngineFactory.createEngineDescription(BreakIteratorSegmenter.class),
				AnalysisEngineFactory.createEngineDescription(TcAnnotatorSequence.class,
