 ...
 */
public class WekaNewTcEvaluationReportDemo
    implements Constants
{
        ...
        throws Exception
    {
    	...
    	DemoUtils.setDkproHome(WekaNewTcEvaluationReportDemo.class.getSimpleName());
    	
        ParameterSpace pSpace = getParameterSpace();

        WekaNewTcEvaluationReportDemo experiment = new WekaNewTcEvaluationReportDemo();
