...
/**
 * Demonstrates the usage of external resources within feature extractors, i.e.
 * nested resources in uimaFit. Resource is created with
 * {@link ExternalResourceFactory#createExternalResourceDescription} and then
 * passed to the feature extractor(s) via the parameter space.
 * 
 */
public class WekaExternalResourceDemo implements Constants {
	...
	public static ParameterSpace getParameterSpace() throws ResourceInitializationException {
		...
		CollectionReaderDescription readerTrain = CollectionReaderFactory.createReaderDescription(
				PairTwentyNewsgroupsReader.class, PairTwentyNewsgroupsReader.PARAM_LISTFILE, listFilePathTrain,
				PairTwentyNewsgroupsReader.PARAM_LANGUAGE_CODE, languageCode);
		dimReaders.put(DIM_READER_TRAIN, readerTrain);

		CollectionReaderDescription readerTest = CollectionReaderFactory.createReaderDescription(
				PairTwentyNewsgroupsReader.class, PairTwentyNewsgroupsReader.PARAM_LISTFILE, listFilePathTest,
				PairTwentyNewsgroupsReader.PARAM_LANGUAGE_CODE, languageCode);
		...
		ExternalResourceDescription gstResource = ExternalResourceFactory.createExternalResourceDescription(
				CosineSimilarityResource.class, CosineSimilarityResource.PARAM_NORMALIZATION,
		...
		ParameterSpace pSpace = new ParameterSpace(Dimension.createBundle("readers", dimReaders),
				Dimension.create(DIM_LEARNING_MODE, LM_SINGLE_LABEL), Dimension.create(DIM_FEATURE_MODE, FM_PAIR),
