...
import org.dkpro.tc.examples.io.UnlabeledTweetReader;
import org.dkpro.tc.examples.util.DemoUtils;
import org.dkpro.tc.features.twitter.EmoticonRatioDFE;
import org.dkpro.tc.features.twitter.NumberOfHashTagsDFE;
import org.dkpro.tc.ml.ExperimentPrediction;
import org.dkpro.tc.weka.WekaPredictionAdapter;
 ...
 */
public class WekaTwitterSentimentPredictionDemo
    implements Constants
{
        ...
        throws Exception
    {
    	...
    	DemoUtils.setDkproHome(WekaTwitterSentimentPredictionDemo.class.getSimpleName());
    	
        ParameterSpace pSpace = getParameterSpace();

        WekaTwitterSentimentPredictionDemo experiment = new WekaTwitterSentimentPredictionDemo();
