    ...
    implements Constants
{
        ...
        throws Exception
    {
    	...
    	DemoUtils.setDkproHome(MekaWekaReutersUsingTCEvaluationDemo.class.getSimpleName());
    	
        ParameterSpace pSpace = getParameterSpace();
        MekaWekaReutersUsingTCEvaluationDemo experiment = new MekaWekaReutersUsingTCEvaluationDemo();
