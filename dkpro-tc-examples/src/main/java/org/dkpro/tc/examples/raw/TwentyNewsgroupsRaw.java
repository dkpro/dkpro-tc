        ...
        throws Exception
    {
        ...
        runPipeline(
                ...
                createEngineDescription(ExtractFeaturesStreamConnector.class,
                        ExtractFeaturesStreamConnector.PARAM_OUTPUT_DIRECTORY,
                        "target/tn_raw_output",
                        ExtractFeaturesStreamConnector.PARAM_DATA_WRITER_CLASS,
                        WekaDataWriter.class, ExtractFeaturesStreamConnector.PARAM_LEARNING_MODE,
