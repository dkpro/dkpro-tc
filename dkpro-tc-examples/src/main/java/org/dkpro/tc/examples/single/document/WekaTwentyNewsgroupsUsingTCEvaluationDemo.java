 ...
 */
public class WekaTwentyNewsgroupsUsingTCEvaluationDemo
    implements Constants
{
        ...
        throws Exception
    {
    	...
    	DemoUtils.setDkproHome(WekaTwentyNewsgroupsUsingTCEvaluationDemo.class.getSimpleName());
    	
        ParameterSpace pSpace = getParameterSpace();

        WekaTwentyNewsgroupsUsingTCEvaluationDemo experiment = new WekaTwentyNewsgroupsUsingTCEvaluationDemo();
    ...
    protected void runTrainTest(ParameterSpace pSpace)
        throws Exception
    {
        ExperimentTrainTest batch = new ExperimentTrainTest("TwentyNewsgroupsCV", WekaClassificationUsingTCEvaluationAdapter.class);
        batch.setPreprocessing(getPreprocessing());
        batch.setParameterSpace(pSpace);
        batch.setExecutionPolicy(ExecutionPolicy.RUN_AGAIN);
