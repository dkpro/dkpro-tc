 ...
 */
public class NewTcEvaluationReportDemo
    implements Constants
{
        ...
        throws Exception
    {
    	...
    	DemoUtils.setDkproHome(NewTcEvaluationReportDemo.class.getSimpleName());
    	
        ParameterSpace pSpace = getParameterSpace();

        NewTcEvaluationReportDemo experiment = new NewTcEvaluationReportDemo();
