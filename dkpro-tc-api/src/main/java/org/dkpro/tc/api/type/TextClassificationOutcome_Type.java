...
public class TextClassificationOutcome_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.dkpro.tc.api.type.TextClassificationOutcome");
  ...
  public String getOutcome(int addr) {
      ...
      jcas.throwFeatMissing("outcome", "org.dkpro.tc.api.type.TextClassificationOutcome");
  ...
  public String getPrediction(int addr) {
      ...
      jcas.throwFeatMissing("prediction", "org.dkpro.tc.api.type.TextClassificationOutcome");
  ...
  public double getWeight(int addr) {
      ...
      jcas.throwFeatMissing("weight", "org.dkpro.tc.api.type.TextClassificationOutcome");
  ...
  public double getConfidence(int addr) {
      ...
      jcas.throwFeatMissing("confidence", "org.dkpro.tc.api.type.TextClassificationOutcome");
