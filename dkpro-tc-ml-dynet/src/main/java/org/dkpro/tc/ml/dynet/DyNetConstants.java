...
public class DyNetConstants
{
    ...
    /**
     * Working memory. In case of GPU processing this values automatically refers to the GPU's
     * working memory
     */
     ...
     * --dynet-gpus X with X being a number from 0 to N depending on the number of GPUs available
     */
    public static final String DIM_DYNET_GPUS = "--dynet-gpus";

    /**
     * Autobatching feature of DyNet. See DyNet documentation for details. Default value is 0 (off),
     * providing 1 (on) turns this feature on.
     */
     ...
     * devices directly i.e. GPU:0 is the first graphic card in the system, CPU:0 is the first CPU.
