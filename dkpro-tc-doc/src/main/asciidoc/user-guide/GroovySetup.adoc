...
### Eclipse Setup
  ...
  * Install the Groovy-Eclipse plugin via the Eclipse marketplace or from any of https://github.com/groovy/groovy-eclipse/wiki[the update sites]. This gives you Groovy capabilities necessary for running and writing Groovy experiments.
