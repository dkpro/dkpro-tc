	...
	extends PairNgramFETestBase
{
	    ...
	    throws Exception
	{
	    ...
	    test.parameters = new Object[] {
                ...
                KeywordNGramPairFeatureExtractor.PARAM_USE_VIEWBLIND_KEYWORD_NGRAMS_AS_FEATURES, false,
                KeywordNGramFeatureExtractorBase.PARAM_NGRAM_KEYWORDS_FILE,
	    ...
	    throws Exception
	{
	    ...
	    test.parameters = new Object[] {
                ...
                "src/test/resources/data/keywordlist.txt",
                KeywordNGramPairFeatureExtractor.PARAM_LUCENE_DIR, test.lucenePath,
                KeywordComboNGramPairFeatureExtractor.PARAM_NGRAM_BINARY_FEATURE_VALUES_COMBO, false,
	            KeywordComboNGramPairFeatureExtractor.PARAM_KEYWORD_NGRAM_MAX_N_COMBO, 2,
