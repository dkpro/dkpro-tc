...
public class MalletUtils
{
	...
	public static void writeFeatureValuesToFile(String featureValues[], String outcome, File outputFile) throws IOException {
	...
	public static void instanceListToMalletFormatFile(File outputFile, FeatureStore instanceList,
		...
		//ArrayList<Instance> normalizedInstanceArrayList = normalizeNumericFeatureValues(instanceArrayList);
	...
	public static ArrayList<Instance> normalizeNumericFeatureValues(ArrayList<Instance> instanceArrayList) {
				...
				if (value instanceof Number) {
					...
					if ((maxNumericFeatureValues[featureIndex] - minNumericFeatureValues[featureIndex]) != 0)
						normalizedDoubleFeatureValues[featureIndex] = 
								(doubleFeatureValue - minNumericFeatureValues[featureIndex])/
								(maxNumericFeatureValues[featureIndex] - minNumericFeatureValues[featureIndex]);
					else
						normalizedDoubleFeatureValues[featureIndex] = 0;
					Feature normalizedFeature = new Feature(normalizedDoubleFeatureValues[featureIndex]);
