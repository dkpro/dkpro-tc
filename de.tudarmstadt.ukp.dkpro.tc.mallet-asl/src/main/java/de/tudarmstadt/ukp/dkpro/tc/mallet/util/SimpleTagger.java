...
public class SimpleTagger
{
  private static Logger logger =
    MalletLogger.getLogger("log4j.properties");
  ...
  public static class SimpleTaggerSentence2FeatureVectorSequence extends Pipe
  {
    ...
    public Instance pipe (Instance carrier)
    {
      ...
      for (int l = 0; l < tokens.length; l++) {
        ...
        //krish
//        double[] featureValues = new double[featureIndices.size()];
//        for (int featureCounter = 0; featureCounter < nFeatures; featureCounter++) {
//        	featureValues[featureCounter] = Double.parseDouble(tokens[l][featureCounter]);
//        }
