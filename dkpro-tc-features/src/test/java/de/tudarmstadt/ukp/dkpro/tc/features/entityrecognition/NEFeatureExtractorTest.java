...
import de.tudarmstadt.ukp.dkpro.tc.features.entityrecognition.NEFeatureExtractor;
...
public class NEFeatureExtractorTest {
		...
		public void nEFeatureExtractorTest() 
	        ...
	        Set<Feature> features1 = extractor.extract(jcas);
		...
		private void testFeatures(Set<Feature> features, int expectedValue1, int expectedValue2, int expectedValue3, float...expectedValues4) {
