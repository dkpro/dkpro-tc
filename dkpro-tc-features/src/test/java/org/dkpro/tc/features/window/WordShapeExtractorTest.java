...
public class WordShapeExtractorTest {
	@Test
	public void numberOfHashTagsFeatureExtractorTest() throws Exception {
		...
		assertEquals("x", extract.get(0).getValue());
		assertEquals("WordShapeu91u451u93", extract.get(1).getName());
		assertEquals("xx", extract.get(1).getValue());
		assertEquals("WordShapeu911u93", extract.get(2).getName());
		assertEquals("xxxx", extract.get(2).getValue());
	}
}
