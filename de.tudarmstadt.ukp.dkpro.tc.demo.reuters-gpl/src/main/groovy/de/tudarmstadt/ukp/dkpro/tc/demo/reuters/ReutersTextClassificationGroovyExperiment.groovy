...
public class ReutersTextClassificationGroovyExperiment implements Constants {
    ...
    def corpusFilePathTrain = "src/test/resources/data/training";
    def corpusFilePathTest = "src/test/resources/data/test";
    def goldLabelFilePath = "src/test/resources/data/cats.txt";
    def languageCode = "en";
    def numFolds = 2;
    def threshold = "0.5";
    ...
    {
        new ReutersTextClassificationGroovyExperiment().runTrainTest();
