...
//                    .getResource("/predictions/multilabelEvaluation.bin").toURI());
    ...
    public void testGenerateOutcomeIdPropertiesSingleLabel() throws ClassNotFoundException, IOException
    {
        ...
        Properties props = new WekaOutcomeIDReport().generateSlProperties(singleLabelData, false, null, labels);
    ...
    {
        Properties props = new WekaOutcomeIDReport().generateSlProperties(regressionData, true, null, null);
